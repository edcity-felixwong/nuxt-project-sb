...
import { StarBanner, StarBreadcrumbNav, StarFooter, StarPage } from "#components";
import {
  BcaTabContent,
  MyPapersTabContent,
  NspTabContent,
...
import { getAvailableTabs, useLoadPaperQuery, usePaperTabs } from "@/services/composites";
import { z } from "zod";
