...
type ControlEnum = "check" | "inline-check" | "radio" | "inline-radio" | "select" | "multi-select";
...
interface SimpleEnumPropType<T extends SimpleArgType["options"]> extends SimplePropType {
...
export const withDefault = (val: SimplePropType["defaultValue"]): Pick<SimpleArgType, "table"> => {
...
export const withDescription = (val: string): Pick<SimplePropType, "description"> => ({
  description: val,
});
// const packDefault = ()
